...
const moduleTemplate = fs.readFileSync(path.join(__dirname, "protoplus.template.mjs"), "utf8");
const webTemplate = fs.readFileSync(path.join(__dirname, "protoplus.template.js"), "utf8");
const templateFiller = fs.readFileSync(path.join(__dirname, "protoplus.filler.js"), "utf8");
